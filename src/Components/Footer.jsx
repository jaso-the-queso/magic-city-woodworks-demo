...
import { Col, Container, Row, Footer, FormInline, Input, Button } from 'mdbreact';
                ...
                <Container className="text-left">
                    <Row>
                        <Col sm="3">
                            ...
                            <p>931 28th Street North <br /> Birmingham, AL</p>
                            <p>(205) 983-7435 <br /> info@magiccitywoodworks.org</p>
                        </Col>
                        <Col sm="3">
