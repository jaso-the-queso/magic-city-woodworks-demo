        ...
        return (
            <div className="container mt-5 pt-5 align-items-center">
                ...
                <div className="row border-bottom border-top align-items-center pt-5 pb-5">
                    <button type="button" className="close col-1" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>                    <img src="../pics/coaster_1_thumb.jpg" alt="Wooden Coasters" width="100" height="66" className="img-fluid col-2 align-self-center rounded" />
                    <div className="col-5">
                        <div className="row">
                ...
                <div className="row border-bottom align-items-center pt-5 pb-5">
                    <button type="button" className="close col-1" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>                    <img src="../pics/groove_1_thumb.jpg" alt="Juice Groove Cutting Board" width="100" height="66" className="img-fluid col-2 align-self-center rounded" />
                    <div className="col-5">
                        <div className="row">
                ...
                <div className="row border-bottom align-items-center pt-5 pb-5">
                    <button type="button" className="close col-1" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>                    <img src="../pics/organizer_1_thumb.jpg" alt="Desk Organizer" width="100" height="66" className="img-fluid col-2 align-self-center rounded" />
                    <div className="col-5">
                        <div className="row">
