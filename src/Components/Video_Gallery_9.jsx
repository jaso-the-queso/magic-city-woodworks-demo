...
export default class Video_Gallery_9 extends Component {
    render() {
        return (
            <div>
                <div className="container mt-5 pt-5 justify-content-center">
                    <div className="row main mt-4 ">
                        ...
                        <div className="col-md-2">
                            <Link to="/gallery" className="text-right black-text hover">Photo Gallery</Link>
                        </div>
                    </div>

                    <div class="vid-container">
                        <iframe src="https://player.vimeo.com/video/157227016" title="Magic City Woodworks Video" width="640" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                    </div>
