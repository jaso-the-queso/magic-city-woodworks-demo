...
export default class Walnut_Chopping_Block_Sale extends Component {
                ...
                <div className="container my-5 pt-5">
                    <div className="row justify-content-between">
                        <ul className="list-unstyled col-md- d-inline mt-4">
                            ...
                            <li className="d-inline text-dark">WALNUT + OAK END GRAIN CHOPPING BLOCK</li>
                        </ul>
                        <ul className="list-unstyled col d-inline mt-4 text-right">
                            <Link to="/shop_main/assorted_chopping_block_sale" className="d-inline text-dark py-3"> PREVIOUS</Link>
                            <li className="d-inline text-dark"> / </li>
                            <Link to="/shop_main/oak_chopping_block_sale" className="d-inline text-dark py-3">NEXT</Link>
                        </ul>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-5">
                            <h1>Walnut + Oak End Grain Chopping Block</h1>
                            <h3 className="py-4">from $90.00</h3>
                        ...
                        <div className="col-md-7">
                            <img src="../pics/walnut_block_1_big.jpg" className="img-fluid rounded mb-2" alt="Walnut Chopping Block" />
                            <img src="../pics/walnut_block_2_big.jpg" className="img-fluid rounded mb-2" alt="Walnut Chopping Block" />
                        </div>
                    </div>
                </div>
            </div>
