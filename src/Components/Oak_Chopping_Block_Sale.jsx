...
export default class Oak_Chopping_Block_Sale extends Component {
                ...
                <div className="container my-5 pt-5">
                    <div className="row justify-content-between">
                        <ul className="list-unstyled col-md- d-inline mt-4">
                            ...
                            <li className="d-inline text-dark">OAK END GRAIN CHOPPING BLOCK</li>
                        </ul>
                        <ul className="list-unstyled col d-inline mt-4 text-right">
                            <Link to="/shop_main/walnut_chopping_block_sale" className="d-inline text-dark py-3"> PREVIOUS</Link>
                            <li className="d-inline text-dark"> / </li>
                            <Link to="/shop_main/measure_twice_tee_sale" className="d-inline text-dark py-3">NEXT</Link>
                        </ul>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-5">
                            <h1>Oak End Grain Chopping Block</h1>
