...
export default class Sweatshirt_Dark_Sale extends Component {
                ...
                <div className="container my-5 pt-5">
                    <div className="row justify-content-between">
                        <ul className="list-unstyled col-md- d-inline mt-4">
                            ...
                            <li className="d-inline text-dark">CLASSIC SWEATSHIRT DARK GREY</li>
                        </ul>
                        <ul className="list-unstyled col d-inline mt-4 text-right">
                            <Link to="/shop_main/classic_tee_navy_sale" className="d-inline text-dark py-3"> PREVIOUS</Link>
                            <li className="d-inline text-dark"> / </li>
                            <Link to="/shop_main/sweatshirt_light_sale" className="d-inline text-dark py-3">NEXT</Link>
                        </ul>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-5">
                            <h1>Classic Sweatshirt Dark Grey</h1>
