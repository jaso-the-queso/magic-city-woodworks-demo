...
export default class Video_Gallery_7 extends Component {
    render() {
        return (
            <div>
                <div className="container mt-5 pt-5 justify-content-center">
                    <div class="vid-container">
                        <iframe src="https://player.vimeo.com/video/162999053" title="Magic City Woodworks Video" width="640" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                    </div>
